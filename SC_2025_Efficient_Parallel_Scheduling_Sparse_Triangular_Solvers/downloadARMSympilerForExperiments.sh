...
echo " "
echo "On confirmation, the repository will be cloned and a patch will be applied to the sympiler code."
echo "The patch will modify the code to allow for running SpTrSV experiments."
echo ""
echo "The script will also attempt to build sympiler which requires cmake, make, and gcc"
...
if [[ "$REPLY" = "yes" ]]; then
    ...
    patch -p0 < patches/experiments_ARM.patch
